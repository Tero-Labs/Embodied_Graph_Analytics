...
public class EdgeElementScript : MonoBehaviour
{
    ...
    */
    ...
    public GameObject FinishEdgeLine(Mesh combinedMesh = null)
    {
        ...
        this.gameObject.GetComponent<MeshRenderer>().sharedMaterial = this.icon_elem_material;
        ...
        this.gameObject.GetComponent<BoxCollider>().size = this.gameObject.GetComponent<MeshFilter>().sharedMesh.bounds.size;
        this.gameObject.GetComponent<BoxCollider>().center = this.gameObject.GetComponent<MeshFilter>().sharedMesh.bounds.center;
        ...
        this.gameObject.transform.position = new Vector3(0, 0, 0); //meshObj.transform.position;

        // update the previous_position variable for templine for checkMove()
        this.previous_position = this.gameObject.transform.position;

        // Save the area of the bounding box 
        this.attribute.Area =
            this.gameObject.GetComponent<MeshFilter>().sharedMesh.bounds.size.x *
            this.gameObject.GetComponent<MeshFilter>().sharedMesh.bounds.size.y * unitScale * unitScale;

        // set current_attribute of penLine
        this.current_attribute = this.attribute.Length;
